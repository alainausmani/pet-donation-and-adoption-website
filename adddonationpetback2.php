...
<div class="container">
    ...
    <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                        <input type="text" id="amount_needed" class="form-control form-control-lg"
                               placeholder="Enter amount needed" name="amount_needed">
                        <label class="form-label" for="amount_needed" style="color: white;"></label>
                    </div>
